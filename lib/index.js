...
// register self as soi plugin
soi.registerPlugin('soi-optimizer', plugin, {
  version: soi.utils.readJSON(
    path.join(__dirname + '/../package.json'), { encoding: 'utf8' }).version,
  requires: [],
  cmd: 'optimize',
  args: {
    'file': soi.utils.nullFunction,
    'f': soi.utils.nullFunction
  }
});
